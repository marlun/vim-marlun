...
syn region  javaScriptTemplateString   start=+`+  skip=+\\`+  end=+`+     contains=javaScriptTemplateExpression,javaScriptSpecial,@Spell extend
syn match   javaScriptTaggedTemplate   /\<\K\k*\ze`/ nextgroup=javaScriptTemplateString
syntax region  javaScriptTemplateExpression contained start=+${+ end=+}+ keepend
...
hi def link javaScriptTaggedTemplate		String
